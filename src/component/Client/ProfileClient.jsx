...
export default class ProfileClient extends Component {
  ...
  componentDidMount(){
    ...
    axios.get( 'https://freelancerapis.herokuapp.com/user/language/')
            .then( res =>this.setState ({ Languagelist:res.data}))
            .catch( err => err.response)
  ...
  onSubmit(e){
    ...
    if(this.state.language.length == 0){
       console.log('language')
        ...
        const languages = this.state.language.map(item => item.value)
        const ProfileData={
          ...
          axios
              .post('https://freelancerapis.herokuapp.com/client/profile/',ProfileData)
  ...
  render() {
    ...
    const { message ,err , Languagelist} = this.state;
                            ...
                            <form onSubmit={this.onSubmit} className="col-md-9">
                                <div className="main-1">
                                    <div className="ddd">
                                        ...
                                        <Link to="/clientEditProfile"><button className="bt-edit">Edit</button></Link>
                                    </div>
                                <div className="pr-img">
                                    ...
                                    <div className="title col-md-6">
                                        ...
                                        <div className="tb-description">
                                        <input type="email"  className="dscr"  value={this.state.email} onChange={this.handleChange} name="email" placeholder="Email Id"/>
                                        </div>
                                    </div>
                                    ...
                                    <div className="title col-md-6">
                                        <h6 className="h6p-1">Language</h6>
                                        <Select options={Languagelist} isMulti value={this.state.language} onChange={this.handleChecks.bind(this)} ></Select>
                                    </div>
                                    ...
                                    {message ==='successfully' && (
                                        ...
                                        <div className="msgError">You Submmitted the Profile Successfully </div>
                                        
                                        )}
                                        {err ==='username existed' && (
                                        
                                        <div className="Error">You already Filled the details</div>
